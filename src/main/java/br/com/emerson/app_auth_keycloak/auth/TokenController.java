package br.com.emerson.app_auth_keycloak.auth;
...
public class TokenController {
    ...
    public ResponseEntity<String> token(@RequestBody User user) {
       ...
       var result = rt.postForEntity("http://localhost:8080/realms/keyTest/protocol/openid-connect/token", entity, String.class);
